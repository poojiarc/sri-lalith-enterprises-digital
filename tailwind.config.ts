    ...
    extend: {
      colors: {
        ...
        brand: {
          ...
          "dark-grey": "hsl(var(--brand-dark-grey))",
      ...
      boxShadow: {
        ...
        "glow-blue": "0 0 40px rgba(110, 193, 228, 0.3)",
      },
      backgroundImage: {
        "hero-gradient": "linear-gradient(135deg, #0F0F0F 0%, #1A3C5A 50%, #0F0F0F 100%)",
        "green-gradient": "linear-gradient(135deg, #4CAF50 0%, #45a049 100%)",
        "blue-gradient": "linear-gradient(135deg, #6EC1E4 0%, #5ba8cc 100%)",
